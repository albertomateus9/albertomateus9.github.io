...
- Curadoria de Telecomunicações, Redes, Visão Computacional, IA aplicada e Educação Tecnológica.
- Catálogo gerado a partir de snapshot da GitHub API e manifesto manual em `src/data/curation.ts`.
- Retrato profissional otimizado para web com tratamento vetorial no hero.
